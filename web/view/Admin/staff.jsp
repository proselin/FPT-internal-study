...
<html lang="en">
    ...
    <body>
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="staff.jsp" style="background-color: rgb(119, 163, 204);"><i class="fas fa-user-edit"> Staff</i></a>
                        </li>
                        <li class="nav-item">
        ...
        <div id="add-search">
            <div class="add">
                <button id="addTrainee" class="button"><span>Add new staff </span></button>
            </div>
            <div class="search">
                <form>
                    <input type="text" name="search" placeholder="Search staff..." id="myInput">
                </form> 
            </div>
        </div>
        <br>
            ...
            <div class="container">
                <table class="table table-bordered">
                    ...
                    <c:if test="${empty requestScope['listS']}">
                        <jsp:forward page = "/StaffController?ac=view" />
                    </c:if>
                    <c:forEach items="${listS}" var = "x" >
                        <tr>
                            ...
                            <td>${x.getUsername()}</td>
                            <td>${x.getPassword()}</td>
                            <td><a href="../../StaffController?ac=getid&id=${x.getUserID()}">Update</a></td>
                            <td><a href="../../StaffController?ac=del&id=${x.getUserID()}">Delete</a></td>
                        </tr>
                    </c:forEach>
                    </tbody>
                </table>
        ...
        <div id="add-new">
            ${error}
            <form action="../../StaffController?ac=add" method="POST">
