...
<body>
    ...
    <div class="search">
        <form>
            <input type="text" name="search" placeholder="Search trainne..." id="myInput">
        </form> 
    </div>     
    <br>
    <br>
    ...
    <div class="container">
        <table class="table table-bordered">
            ...
            <tbody id="myTable">
              <tr>
                 <c:if test="${empty requestScope['listTne']}">
                            <jsp:forward page = "/Add_Trainee_Controller" />
                        </c:if>
                        <c:forEach items="${listTne}" var = "x" >
                            <tr>
                                <td>${x.getUserID()}</td>
                                <td>${x.getFullName()}</td>
                                <td>${x.getAddress()}</td>
