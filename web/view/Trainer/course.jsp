                ...
                $.ajax({
                    ...
                    <td> " +value.CourseID+"</td> \n\
                     ...
                     <td> " +value.CourseStatus+"</td> \n\
                       <td> " +"<a href = "+"../../CourseController?id="+value.CourseID+">Update Contnet</a>"+"</td> \n\
                        <td> " +"<a href = "+"../../CourseController?id="+value.CourseID+">Add trainee</a>"+"</td> \n\
                         <td> " +"<a href = "+"../../CourseController?id="+value.CourseID+">Edit trainee list</a>"+"</td> \n\
                          <td> " +"<a href = "+"../../CourseController?id="+value.CourseID+">View detail</a>"+"</td> \n\
                    <tr>")
                        });
                    },
                    error: function () {
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
              <ul class="navbar-nav">
                <li class="nav-item">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" href="account.jsp"><i class="fas fa-file-contract"> Account Management</i></a>
                  </li>
                  <li class="nav-item">
