<%-- 
    Document   : AddCourse
    Created on : 22-08-2021, 10:39:31
    Author     : mangn
--%>
...
<html>
        ...
        <script>
            $(document).ready(function () {
                $("#sel3").change(function () {
                    ...
                    $.ajax({
                        url:"../../CourseController?ac=viewTrainer",
                        method : "POST",
    ...
    <body>
        ...
        <div class="container" style="margin-bottom: 300px"> 
            <form action="../../CourseController?ac=add" method="POST">
                <div class="col-md-6" style="float: left">
                    <label for="id">Course ID:</label>
                    <input type="text" class="form-control" id="id" placeholder="Enter Course ID " name="id" required>
                    ...
                    <input type="text" class="form-control" id="room" placeholder="Enter Room" name="room" required>
                    <div class="">
                        <label for="schedule">Schedule:</label>
                        <input type="text" class="form-control" id="schedule" placeholder="Enter Schedule" name="schedule" required>
                    </div>
                    <div class="">
                        <label for="status">Status</label>
                        <input type="text" class="form-control" id="status" value="Studying" name="status" readonly="true">
                    </div>
                </div>
                <div class="col-md-6" style="float: left">
                    <c:if test="${empty requestScope['listCC']}">
                        <jsp:forward page = "/CourseController?ac=viewCC" />
                    </c:if>
                    ...
                    <c:if test="${empty requestScope['listTopic']}">
                        <jsp:forward page = "/CourseController?ac=viewTopic" />
                    </c:if>
                    ...
                    <br>
                    <button type="submit" class="btn btn-primary" style="width: 330px">Add</button>
                </div>
            </form>
        </div>
        <br>
