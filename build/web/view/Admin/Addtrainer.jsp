<%-- 
    Document   : Addtrainer
    Created on : 25-08-2021, 13:22:16
    Author     : mangn
--%>
...
<html>
    ...
    <body>
        ...
        <br>
                   <h1 style="text-align: center">Add new trainer</h1>
                   <br>
        <div id="add-new">
            <form action="../../TrainerModel?ac=add" class="was-validated" method="POST">
                ...
                <c:forEach items="${listTopic}" var = "x" >
                    <input type="checkbox" id="${x.getTopicID()}" name="topics" value="${x.getTopicID()}">
                    <label for="exampleCheck1">${x.getTopicName()}</label>
                </c:forEach>
        <br>
        <br>
        <input type="submit" class="btn btn-primary" value="add" style="margin-left: 40%" >
    </form>
</div>
    </body>
</html>
